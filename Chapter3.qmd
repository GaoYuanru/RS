...
6.  ::: {.callout-note style="color" appearance="simple"}
...
(1) ::: {.callout-note appearance="simple"}
    -   (observed - predicted (the residual))\^2</br>

    -   sum them and divide by number of data points</br>

    -   square root that total</br>
    :::

<!-- -->

7.  ::: {.callout-note style="color" appearance="simple"}
    ::: {.callout-note appearance="simple"}
    :::
    :::
